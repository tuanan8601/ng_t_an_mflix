...
public class HomeController implements controller.IController {
    ...
    public void process( final HttpServletRequest request, final HttpServletResponse response, final ServletContext servletContext, final ITemplateEngine templateEngine)  throws Exception {
        ...
        ctx.setVariable("site_name", "KTQD");

        ConnectionString connectionString = new ConnectionString("mongodb+srv://tuanan8601:fourin1234@cluster0.u4rda.mongodb.net/sample_mflix?retryWrites=true&w=majority");
